...
close all; clear all; clear boom;
addpath('share');
...
% torque_knee = 0.17; torque_hip = 0; % Hip motor.
% boom.Motors.setTorques([torque_knee torque_hip]);
% pauseSafe(boom, 4); % Pressing Ctrl+C switches to idle mode. Otherwise same as pause.
...
save('mane_pd_v1_trq-sin_ws.mat')